      ...
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            <h1 data-aos="fade-up" className="text-3xl sm:text-4xl font-bold">Winter Sale 50% off</h1>
            <p data-aos="fade-up" className="text-sm text-gray-500 trackin-wide leading-5">Experience the magic of winter with our exclusive Winter Sale! Enjoy incredible savings of up to 50% off on a wide range of products. </p>
