      ...
      <div className="container">
        ...
        <div>
          ...
          <div className='flex justify-center mb-20'>
            <button data-aos="fade-up" className='text-center bg-primary mt-10 cursor-pointerbg-primary text-white py-1 px-5 rounded-md'>View All Button</button>
          </div>
        </div>
      </div>
    </div>
